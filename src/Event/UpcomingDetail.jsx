...
import BookingupcomingEvent from './BookingupcomingEvent'
const UpcomingDetail = () => {
    ...
    <Navbar/>
        ...
        <div ><img src={'http://127.0.0.1:8000'+event.photo} className=" h-80" alt="errror"></img></div>
        <div>
   ...
   <div className='flex justify-end'><button onClick={handleOpenPopUp} className='hover:bg-purple-400 bg-purple-500 text-white px-8 py-1 rounded '>Book Now</button></div>
      ...
      <UpcomingEvent/>
      {showPopUp && (
                    <BookingupcomingEvent data={dataToShow} onClose={handleClosePopUp} />
                )}
