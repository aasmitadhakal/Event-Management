                    ...
                    <div className='rounded  py-4 shadow-xl '>
                        ...
                        <div className='mt-4'>
                            ...
                            <div className='flex justify-between mx-8 font-serif font-[400] text-slate-500'>
                                <div className='flex items-center'><FaLocationDot className='mx-1'/>{event.location}</div>
                                <div className='flex items-center'><MdDateRange className='mx-1'/>{event.date}</div>
                            </div>
                        </div>
                    </div>
                </Link>
