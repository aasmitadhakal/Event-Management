...
export default function Register({setHasaccount,visible,onClose}) {
  ...
  return (
    ...
    <form className='mx-96    border bg-white shadow-md rounded'>
      <h1 className='text-3xl mt-12 mb-8 flex justify-center items-center  font-bold text-pink '>Registration</h1>
      {/* for all field */}
...
<div>
      ...
      onChange={handleuser}
        ...
        className='text-slate-500 mx-64  m-2 mb-12 '>
        Don't have an account ?<span className="hover:underline hover:decoration-pink hover:decoration-2 ">Login</span>
        </div>
    </form>
    </div>
