...
<div className='  mt-18 flex justify-center items-center p-12 '>
   <form onSubmit={handleAPi}
    ...
    {/* for buttom */}
    <div className=''>
    <button className='bg-gradient-to-r hover:text-white hover:to-blue-400 from-blue-300 to-purple-600 text-white mt-4 mb-4  px-8 mx-10 py-2  rounded-2xl'>Submit</button>
    </div>
    <ToastContainer />
  </form>
</div>
