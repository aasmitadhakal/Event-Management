...
function BlogList() {
    ...
    const fetchData = () => {
      axios
        .get(`blog/search/?search=${searchQuery}`)
        .then(response => {
    ...
    const DeleteData=(id,e)=>{
        e.preventDefault();
        axios.delete(`blog/delete/${id}`,config)
        .then(response => {
     ...
     const settoLocalstorage =(id,content)=>{
    ...
    <div className="  overflow-auto rounded-lg shadow mx-24 mt-4  "  >
      ...
      <thead className='bg-white border-b-2 border-gray-200'>
        <tr className="">
          ...
          <th className="w-44 p-3 text-sm font-semibold "> Content</th>
